...
>>>>>>> parent of 5342a45... Remove Fileinfo and adjust several thing
        ...
        final String vertexShaderSource = "uniform mat4 uMVPMatrix;" + "attribute vec4 aPosition;" + "void main() {"
                + "    gl_Position = uMVPMatrix * aPosition;" + "}";

        final String fragmentShaderSource = "precision mediump float;" + "uniform float mAlpha;	 " + "void main() {"
        ...
        final float[] mVerticesData = { 0.0f, 0.5f, 0.0f, -0.5f, -0.5f, 0.0f, 0.5f, -0.5f, 0.0f };
