...
public class Country extends BasicScript {
    ...
    public Country(MicroMovieActivity activity, ProcessGL processGL) {
        ...
        mEffects.add(EffectLib.Bound(processGL, new int[]{500, 5500, 1200, 2400}, 0, Shader.Default, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(processGL, new int[]{500, 5800, 2900, 2400}, 0, Shader.Default, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(processGL, new int[]{1500, 4300, 3400, 2400}, 0, Shader.Default, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(processGL, new int[]{2400, 1500, 2300}, 4000, Shader.Default, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(processGL, new int[]{1600, 3700, 1500}, 1600, Shader.Default, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(processGL, new int[]{1000, 4800, 1500}, 3700, Shader.Default, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(processGL, new int[]{1500, 3200, 2000}, 1300, Shader.Default, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(processGL, new int[]{1500, 3000, 4800, 1500}, 3600, Shader.Cover_Percent_B, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(processGL, new int[]{1500, 2100, 1500}, 3600, Shader.Default, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(processGL, new int[]{2100, 2000, 2000}, 2100, Shader.Default, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(processGL, new int[]{1500, 500, 2000}, 2500, Shader.Default, 0, 0,
