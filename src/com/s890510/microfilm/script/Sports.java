...
public class Sports extends BasicScript {
    ...
    public Sports(boolean isFromEncode, MicroFilmActivity activity, GLDraw mGLDraw) {
        this(activity, mGLDraw);
        mIsFromEncode = isFromEncode;
    }

    public Sports(MicroFilmActivity activity, GLDraw mGLDraw) {
        ...
        mEffects.add(EffectLib.Translate(mGLDraw, new int[]{700, 300, 1100}, 0, Shader.Default,
        ...
        mEffects.add(EffectLib.Scale_Fade(mGLDraw, new int[]{500, 1200, 500}, 1700, Shader.Scale_Mask,
        ...
        mEffects.add(EffectLib.Scale_Fade(mGLDraw, new int[]{500, 600, 500}, 1100, Shader.Scale_Mask,
        ...
        mEffects.add(EffectLib.Scale_Fade(mGLDraw, new int[]{500, 800, 300, 1000}, 2300, Shader.Scale_Mask,
        ...
        mEffects.add(EffectLib.Scale_Fade(mGLDraw, new int[]{300, 900}, 0, Shader.Cover_Top,
        ...
        mEffects.add(EffectLib.Scale_Fade(mGLDraw, new int[]{300, 900}, 900, Shader.Cover_Bottom,
                new boolean[]{true, false}, new int[]{0, 0}, 0, 0,
                new float[]{1.0f, 1.0f}, new float[]{1.0f, 1.0f}, new float[]{1.0f, 1.0f}, new float[]{1.0f, 1.0f},
                0.5f, 1.0f, new int[]{0, 0}, new int[]{4 ,4}));

        mEffects.add(EffectLib.Scale_Fade(mGLDraw, new int[]{300, 800}, 0, Shader.Cover_Half_Right,
                new boolean[]{true, false}, new int[]{0, 0}, 0, 0,
                new float[]{1.0f, 1.0f}, new float[]{1.0f, 1.0f}, new float[]{1.0f, 1.0f}, new float[]{1.0f, 1.0f},
                0.5f, 1.0f, new int[]{0, 0}, new int[]{3 ,3}));
        mEffects.add(EffectLib.Scale_Fade(mGLDraw, new int[]{300, 800}, 800, Shader.Cover_Half_Left,
                new boolean[]{true, false}, new int[]{0, 0}, 0, 0,
                new float[]{1.0f, 1.0f}, new float[]{1.0f, 1.0f}, new float[]{1.0f, 1.0f}, new float[]{1.0f, 1.0f},
                0.5f, 1.0f, new int[]{0, 0}, new int[]{4 ,4}));
        ...
        mEffects.add(EffectLib.Scale_Fade(mGLDraw, new int[]{900, 500, 700, 500}, 0, Shader.Scale_Fade,
                new boolean[]{false, false, false, false}, new int[]{0, 0, 0, 0}, 0, 0,
        ...
        mEffects.add(EffectLib.Translate(mGLDraw, new int[]{500, 400, 500}, 2100, Shader.Mirror_Vertical_TB,
        ...
        mEffects.add(EffectLib.Scale_Fade(mGLDraw, new int[]{500, 700, 500}, 1200, Shader.Scale_Fade,
                new boolean[]{false, false, false}, new int[]{0, 0, 0}, 0, 0,
        ...
        mEffects.add(EffectLib.Scale_Fade(mGLDraw, new int[]{500, 700, 500}, 1700, Shader.Scale_Fade,
                new boolean[]{false, false, false}, new int[]{0, 0, 0}, 0, 0,
                new float[]{0.70f, 0.72f, 0.75f}, new float[]{0.72f, 0.75f, 0.9f}, new float[]{0.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 0.0f},
                1.0f, 1.0f, new int[]{0, 0, 0}, new int[]{2, 2, 2}));

        mEffects.add(EffectLib.Translate(mGLDraw, new int[]{1100, 300, 1500}, 0, Shader.Default,
                new boolean[]{false, false, false}, new int[]{0, 0, 0}, 0, 0, false,
        ...
        mEffects.add(EffectLib.Scale_Fade(mGLDraw, new int[]{1000, 1000}, 1500, Shader.Lattice_Tilted_Right_R,
                new boolean[]{true, false}, new int[]{0, 0}, 0, 0,
                new float[]{1.0f, 1.0f}, new float[]{1.0f, 1.0f}, new float[]{1.0f, 1.0f}, new float[]{1.0f, 1.0f},
                1.0f, 1.0f, new int[]{0, 0}, new int[]{1, 1}));

        mEffects.add(EffectLib.Scale_Fade(mGLDraw, new int[]{500, 500, 500}, 1500, Shader.Lattice_Cross_4,
        ...
        mEffects.add(EffectLib.Cover(new int[]{500, 600, 500}, 0, Shader.Cover_Top,
                new boolean[]{true, false, true}, new int[]{0, 0, 0}, 0, 0, -mGLDraw.ScreenRatio, -1,
        ...
        mEffects.add(EffectLib.Translate(mGLDraw, new int[]{500, 500, 500}, 1500, Shader.Mirror_Tilted_Left,
        ...
        mEffects.add(EffectLib.Translate(mGLDraw, new int[]{3400}, 0, Shader.Default,
        ...
        mEffects.add(EffectLib.Scale_Fade(mGLDraw, new int[]{900, 400, 600}, 1600, Shader.Lattice_Tilted_Right_R,
                new boolean[]{true, false, true}, new int[]{0, 0, 0}, 0, 0,
                new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f},
