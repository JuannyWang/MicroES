...
public class Memory extends BasicScript {
    ...
    public Memory(MicroMovieActivity activity, ProcessGL processGL) {
        ...
        mEffects.add(EffectLib.Scale_Fade(processGL, new int[]{3000, 2400, 1500}, 0, Shader.Default,
        ...
        mEffects.add(EffectLib.Scale_Fade(processGL, new int[]{5400, 1500, 5000, 1600}, 0, Shader.Default,
        ...
        mEffects.add(EffectLib.Scale_Fade(processGL, new int[]{1000, 4500}, 900, Shader.Scale_Fade,
        ...
        mEffects.add(EffectLib.Scale_Fade(processGL, new int[]{1000, 2000}, 2000, Shader.Scale_Fade,
                new boolean[]{false, false}, new int[]{0, 0}, 1, 30,
                new float[]{1.1f, 1.0846f}, new float[]{1.0846f, 1.0307f}, new float[]{0.0f, 1.0f}, new float[]{1.0f, 1.0f},
                0.5f, 1.0f, new int[]{0, 0}, new int[]{4, 4}));

        mEffects.add(EffectLib.Scale_Fade(processGL, new int[]{1000, 1900, 1000}, 3300, Shader.Scale_Fade_Bar_TRANS_IN,
        ...
        mEffects.add(EffectLib.Translate(processGL, new int[]{2300, 4500, 1400, 2700}, 0, Shader.Scale_Fade_Bar_SHOWN,
        ...
        mEffects.add(EffectLib.Translate(processGL, new int[]{2300, 4500, 1400, 4100}, 0, Shader.Scale_Fade_Bar_SHOWN,
        ...
        mEffects.add(EffectLib.Translate(processGL, new int[]{2300, 4300, 1500}, 1600, Shader.Scale_Fade_Bar_SHOWN,
        ...
        mEffects.add(EffectLib.Translate(processGL, new int[]{2300, 2700, 1500}, 2200, Shader.Scale_Fade_Bar_SHOWN,
                ...
                new float[]{1.0f, 1.0f, 1.0f}, new float[]{0.0f, 1.0f, 1.0f},
                new float[]{1.0f, 1.0f, 0.0f}, 0.5f, 1.0f, new int[]{0, 0, 0}, new int[]{1, 1, 1}));
        mEffects.add(EffectLib.Translate(processGL, new int[]{2300, 500, 1500}, 2800, Shader.Scale_Fade_Bar_SHOWN,
                ...
                new float[]{1.0f, 1.0f, 1.0f}, new float[]{0.0f, 1.0f, 1.0f},
                new float[]{1.0f, 1.0f, 0.0f}, 0.5f, 1.0f, new int[]{0, 0, 0}, new int[]{1, 1, 1}));
        mEffects.add(EffectLib.Scale_Fade(processGL, new int[]{1500, 1700, 1500}, 3200, Shader.Scale_Fade_Bar_SHOWN,
        ...
        mEffects.add(EffectLib.Scale_Fade(processGL, new int[]{1500, 1100, 1500}, 2600, Shader.Scale_Fade_Bar_SHOWN,
                new boolean[]{false, false, false}, new int[]{0, 0, 0}, 1, 32,
                new float[]{1.1f, 1.0634f, 1.0319f}, new float[]{1.0634f, 1.0319f, 1.0f}, new float[]{0.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 0.0f},
                1.0f, 1.0f, new int[]{0, 0, 0}, new int[]{2, 2, 2}));

        mEffects.add(EffectLib.Scale_Fade(processGL, new int[]{1500, 1200, 2000}, 2700, Shader.Scale_Fade_Bar_SHOWN,
        ...
        mEffects.add(EffectLib.Scale_Fade(processGL, new int[]{2000, 700, 2300}, 3000, Shader.Scale_Fade_Bar_SHOWN,
