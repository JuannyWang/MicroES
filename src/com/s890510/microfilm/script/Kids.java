...
public class Kids extends BasicScript {
    ...
    public Kids(MicroMovieActivity activity, ProcessGL processGL) {
        ...
        mEffects.add(EffectLib.Rotate_Translate(new int[]{700, 1200, 1000}, 700, Shader.Rotate,
                ...
                new float[]{180.0f, 0.0f, 0.0f}, new float[]{360.0f, 0.0f, 0.0f},
        ...
        mEffects.add(EffectLib.Rotate_Translate(new int[]{1000, 700, 600}, 0, Shader.Rotate,
                ...
                new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 0.0f},
                new float[]{0.0f, 0.0f, 0.0f}, new float[]{0.0f, 0.0f, 360.0f},
        ...
        //--#12 27+6+2 27+6
        mEffects.add(EffectLib.String(new int[]{3500}, 3300, new boolean[]{true, false}, Shader.String, null,
                new boolean[]{false, false, false}, new int[]{0, 0, 0},
                new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 0.0f}, new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f}, 1.0f, 1.0f,
        ...
        //--#15
        mEffects.add(EffectLib.String(new int[]{4200}, 4000, new boolean[]{true, false}, Shader.String, null,
                new boolean[]{false, false, false}, new int[]{0, 0, 0},
                new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 0.0f}, new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f}, 1.0f, 1.0f,
        ...
        mEffects.add(EffectLib.String(new int[]{3700}, 3500, new boolean[]{true, false}, Shader.String, null,
                new boolean[]{false, false, false}, new int[]{0, 0, 0},
                new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 0.0f}, new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f}, 1.0f, 1.0f,
                new int[]{StringLoader.STRING_KIDS_ICON_A, StringLoader.STRING_KIDS_ICON_A}, new int[]{9, 9, 9}, 40, 1));
        ...
        mEffects.add(EffectLib.String(new int[]{3300}, 3300, new boolean[]{true, false}, Shader.String, null,
                new boolean[]{false, false, false}, new int[]{0, 0, 0},
                new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 0.0f}, new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f}, 1.0f, 1.0f,
                new int[]{StringLoader.STRING_KIDS_ICON_B, StringLoader.STRING_KIDS_ICON_B}, new int[]{9, 9, 9}, 40, 1));
        ...
        //--30.6s
        //--#23, #24
        mEffects.add(EffectLib.String(new int[]{600, 900, 2200}, 3300, new boolean[]{false, false, false}, Shader.Lattice_Blue_Bar_String, mString_2,
                new boolean[]{true, false, false}, new int[]{0, 0, 0},
                new float[]{1.4f, 1.24f, 1.0f}, new float[]{1.24f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f}, 1.0f, 1.0f,
                new int[]{StringLoader.STRING_KIDS_END, StringLoader.STRING_KIDS_END, StringLoader.STRING_KIDS_END}, new int[]{2, 2, 2}, 80, 0));

        mEffects.add(EffectLib.String(new int[]{500}, 500, new boolean[]{false}, Shader.CMask, mString_2,
                new boolean[]{true}, new int[]{0},
                new float[]{0.0f}, new float[]{0.0f}, new float[]{0.0f}, new float[]{0.0f}, 1.0f, 1.0f,
                new int[]{Mask.TRANS_IN_BIG}, new int[]{2}, 0, 0));

        mEffects.add(EffectLib.Slogan(new int[]{500, 1000, 2300}, 3700, Shader.Slogan_TypeB,
                new float[]{0.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f},
