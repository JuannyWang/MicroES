...
public class Carnival extends BasicScript {
    ...
    public Carnival(boolean isFromEncode, MicroFilmActivity activity, GLDraw gldraw) {
        this(activity, gldraw);
        mIsFromEncode = isFromEncode;
    }

    public Carnival(MicroFilmActivity activity, GLDraw gldraw) {
        ...
        mEffects.add(EffectLib.Translate(gldraw, new int[]{800, 1100, 300}, 1900, Shader.Default,
        ...
        mEffects.add(EffectLib.Translate(gldraw, new int[]{300, 2000, 300}, 2300, Shader.Default,
        ...
        mEffects.add(EffectLib.Translate(gldraw, new int[]{300, 1600, 300}, 1900, Shader.Default,
                new boolean[]{false, false, false}, new int[]{0, 0, 0}, 0, 0, true,
                new float[]{-mRatio*2.1f, -mRatio*0.1f, -mRatio*2.1f},
                new float[]{-mRatio*2.1f, 0f, mRatio*0.1f}, new float[]{1.1f, 1.1f, 1.1f}, new float[]{1.1f, 1.1f, 1.1f}, new float[]{1.0f, 1.0f, 1.0f},
                new float[]{1.0f, 1.0f, 1.0f}, 1.0f, 1.0f, new int[]{0, 0, 0}, new int[]{1, 1, 1}));
        ...
        mEffects.add(EffectLib.Scale_Fade(gldraw, new int[]{800, 900, 500}, 1700, Shader.Line,
        ...
        mEffects.add(EffectLib.Scale_Fade(gldraw, new int[]{500, 1200, 500}, 1700, Shader.Scale_Fade,
        ...
        mEffects.add(EffectLib.Scale_Fade(gldraw, new int[]{500, 1900}, 1700, Shader.Scale_Fade,
        ...
        mEffects.add(EffectLib.Translate(gldraw, new int[]{500, 2900}, 100, Shader.Default,
        ...
        mEffects.add(EffectLib.Translate(gldraw, new int[]{500, 2800}, 100, Shader.Default,
                new boolean[]{false, false}, new int[]{2, 0}, 0, 0, true,
        ...
        mEffects.add(EffectLib.Translate(gldraw, new int[]{500, 2700}, 2700, Shader.Default,
                new boolean[]{false, false}, new int[]{2, 0}, 0, 0, true,
        ...
        mEffects.add(EffectLib.Scale_Fade(gldraw, new int[]{500, 700}, 500, Shader.Cover_Empty_Left,
        ...
        mEffects.add(EffectLib.Translate(gldraw, new int[]{700, 300, 2500}, 0, Shader.Default,
        ...
        mEffects.add(EffectLib.Translate(gldraw, new int[]{700, 900, 300}, 1600, Shader.Line,
        ...
        mEffects.add(EffectLib.Translate(gldraw, new int[]{300, 1400, 300}, 1700, Shader.Default,
                new boolean[]{false, false, false}, new int[]{0, 0, 0}, 0, 0, true,
        ...
        mEffects.add(EffectLib.Translate(gldraw, new int[]{300, 1400, 300}, 1700, Shader.Default,
                ...
                new float[]{1.0f, 1.0f, 1.1f}, new float[]{1.0f, 1.1f, 1.1f}, new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f},
                1.0f, 1.0f, new int[]{0, 0, 0}, new int[]{1, 2, 1}));
        mEffects.add(EffectLib.Translate(gldraw, new int[]{300, 1700, 300}, 2000, Shader.Default,
                new boolean[]{false, false, false}, new int[]{0, 0, 0}, 0, 0, true,
                new float[]{-mRatio*2.1f, 0, -mRatio*2.1f}, new float[]{-mRatio*2.1f, 0f, 0f},
                new float[]{1.0f, 1.0f, 1.1f}, new float[]{1.0f, 1.1f, 1.1f}, new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f},
                1.0f, 1.0f, new int[]{0, 0, 0}, new int[]{1, 2, 1}));
        mEffects.add(EffectLib.Translate(gldraw, new int[]{300, 1700, 300}, 2300, Shader.Default,
                new boolean[]{false, false, false}, new int[]{0, 0, 0}, 0, 0, true,
