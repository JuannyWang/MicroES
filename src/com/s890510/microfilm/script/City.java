...
public class City extends BasicScript {
    ...
    public City(MicroMovieActivity activity, ProcessGL processGL) {
        ...
        //--#1
        mEffects.add(EffectLib.Bound(processGL, new int[]{500, 3700, 400}, 0, Shader.Default, 0, 0,
        ...
        //--#2
        mEffects.add(EffectLib.Bound(processGL, new int[]{400, 2300, 400}, 0, Shader.Default, 0, 0,
        ...
        //--#3
        mEffects.add(EffectLib.Bound(processGL, new int[]{400, 2200, 400}, 0, Shader.Default, 0, 0,
                new float[]{mScreenRatio*2, 0.0f, 0.0f}, new float[]{0.0f, 0.0f, -mScreenRatio*2},
                new float[]{0.1f, 0.1f, -0.1f}, new float[]{0.1f, -0.1f, -0.1f}, -0.8f, 0.8f,
                new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f},
                1.0f, 1.0f, new boolean[]{false, false, false}, new int[]{Shader.LIMIT_Y, Shader.LIMIT_Y, Shader.LIMIT_Y}, new int[]{2, 2, 2}));
        ...
        //--#4
        mEffects.add(EffectLib.Bound(processGL, new int[]{400, 1800, 400}, 0, Shader.Default, 0, 0,
        ...
        */
        ...
        //--#9
        mEffects.add(EffectLib.Bound(processGL, new int[]{400, 1600, 400}, 2000, Shader.Default, 0, 0,
        ...
        //--#11
        mEffects.add(EffectLib.Bound(processGL, new int[]{400, 1500}, 1600, Shader.Default, 0, 0,
        ...
        //--#12
        mEffects.add(EffectLib.Bound(processGL, new int[]{300, 1100}, 1400, Shader.Default, 0, 0,
                new float[]{0.0f, 0.0f}, new float[]{0.0f, 0.0f},
        ...
        //--#13
        mEffects.add(EffectLib.Bound(processGL, new int[]{100, 300}, 400, Shader.Default, 0, 0,
                new float[]{0.0f, 0.0f}, new float[]{0.0f, 0.0f},
        ...
        //#16
        mEffects.add(EffectLib.Bound(processGL, new int[]{100, 1400}, 400, Shader.Default, 0, 0,
                new float[]{0.0f, 0.0f}, new float[]{0.0f, 0.0f},
                new float[]{0.0f, 0.0f}, new float[]{0.0f, 0.0f}, -1.0f, 1.0f,
        ...
        mEffects.add(EffectLib.Bound(processGL, new int[]{700, 400, 1200}, 1900, Shader.Cover_Percent_L, 0, 0,
                new float[]{mScreenRatio*2, 0.0f, 0.0f}, new float[]{0.0f, 0.0f, 0.0f},
        ...
        //--#21, #22
        mEffects.add(EffectLib.Translate(processGL, new int[]{400, 300, 300}, 700, Shader.Mirror_Tilted,
        ...
        //--#23
        mEffects.add(EffectLib.Scale_Fade(processGL, new int[]{300, 400, 300}, 700, Shader.Default_White,
        ...
        //--#25
        mEffects.add(EffectLib.Scale_Fade(processGL, new int[]{300, 600, 300}, 900, Shader.Default_White,
                new boolean[]{false, false, false}, new int[]{0, 0, 0}, 0, 0,
                new float[]{0.71f, 0.715f, 0.725f}, new float[]{0.715f, 0.725f, 0.73f}, new float[]{0.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 0.0f},
                1.0f, 1.0f, new int[]{0, 0, 0}, new int[]{2, 2, 2}));

        //--#26
        mEffects.add(EffectLib.Scale_Fade(processGL, new int[]{300, 300, 300}, 600, Shader.Default_White,
                new boolean[]{false, false, false}, new int[]{0, 0, 0}, 0, 0,
        ...
        mEffects.add(EffectLib.Scale_Fade(new int[]{300, 700, 500}, 1000, Shader.Default_White,
                ...
                1.0f, 1.0f, new int[]{0, 0, 0}, new int[]{2, 2, 2}));
        */
        mEffects.add(EffectLib.Scale_Fade(processGL, new int[]{300, 700, 1000}, 1000, Shader.Default_White,
                new boolean[]{false, false, false}, new int[]{0, 0, 0}, 0, 0,
                new float[]{0.75f, 0.7546f, 0.7654f}, new float[]{0.7546f, 0.7654f, 0.77f}, new float[]{0.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 0.0f},
                1.0f, 1.0f, new int[]{0, 0, 0}, new int[]{2, 2, 2}));
