...
public class Lover extends BasicScript {
    ...
    public Lover(boolean isFromEncode, MicroFilmActivity activity, GLDraw gldraw) {
        this(activity, gldraw);
        mIsFromEncode = isFromEncode;
    }

    public Lover(MicroFilmActivity activity, GLDraw gldraw) {
        ...
        mEffects.add(EffectLib.Bound(gldraw, new int[]{2500, 2500}, 0, Shader.Photo, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(gldraw, new int[]{800, 1000}, 1800, Shader.Photo, 0, 0,
                new float[]{0.0f, 0.0f}, new float[]{0.0f, 0.0f},
                new float[]{0.0f, 0.0f}, new float[]{0.0f, 0.0f}, 1, 1,
        ...
        mEffects.add(EffectLib.Bound(gldraw, new int[]{800, 400}, 1200, Shader.Photo, 0, 0,
                new float[]{0.0f, 0.0f}, new float[]{0.0f, 0.0f},
                new float[]{0.0f, 0.0f}, new float[]{0.0f, 0.0f}, 1, 1,
                new float[]{1.086f, 1.102f}, new float[]{1.102f, 1.122f}, new float[]{0.0f, 1.0f}, new float[]{1.0f, 1.0f},
                0.65f, 0.65f, new boolean[]{false, false}, new int[]{Shader.NONE, Shader.NONE}, new int[]{1, 1}));

        mEffects.add(EffectLib.Bound(gldraw, new int[]{800, 2000}, 2800, Shader.Photo, 0, 0,
                new float[]{0.0f, 0.0f}, new float[]{0.0f, 0.0f},
                new float[]{0.0f, 0.0f}, new float[]{0.0f, 0.0f}, 1, 1,
                new float[]{1.122f, 1.138f}, new float[]{1.138f, 1.166f}, new float[]{0.0f, 1.0f}, new float[]{1.0f, 1.0f},
                0.65f, 0.65f, new boolean[]{false, false}, new int[]{Shader.NONE, Shader.NONE}, new int[]{1, 1}));

        mEffects.add(EffectLib.Bound(gldraw, new int[]{500, 2900, 500}, 500, Shader.Photo, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(gldraw, new int[]{500, 2600, 500}, 500, Shader.Photo, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(gldraw, new int[]{500, 2200, 500}, 500, Shader.Photo, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(gldraw, new int[]{800, 2200, 500}, 1200, Shader.Default, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(gldraw, new int[]{800, 1000, 500}, 2300, Shader.Default, 0, 0,
                new float[]{-mScreenRatio*0.5f, -mScreenRatio*0.5f, -mScreenRatio*0.5f},
                new float[]{-mScreenRatio*0.5f, -mScreenRatio*0.5f, -mScreenRatio*0.5f},
        ...
        mEffects.add(EffectLib.Bound(gldraw, new int[]{500, 4700, 700}, 2200, Shader.Photo, 0, 0,
        ...
        mEffects.add(EffectLib.Bound(gldraw, new int[]{500, 2500, 700}, 3700, Shader.Photo, 0, 0,
                new float[]{mScreenRatio*0.5f, mScreenRatio*0.5f, mScreenRatio*0.5f},
                new float[]{mScreenRatio*0.5f, mScreenRatio*0.5f, mScreenRatio*0.5f},
                new float[]{0.0f, 0.0f, 0.0f}, new float[]{0.0f, 0.0f, 0.0f}, 1, 1,
        ...
        mEffects.add(EffectLib.Scale_Fade(gldraw, new int[]{1000, 1400, 1000}, 1400, Shader.Default,
