...
public class OldFilmFilter extends DefaultFilter {
   ...
   /* private int mBRandomCoord1Handle;
    private int mBRandomCoord2Handle;
    private int mBNoiseSamplerHandle;
    private int mBNoiseTextureID;
    
    private int mVRandomCoord1Handle;
    private int mVRandomCoord2Handle;
    private int mVNoiseSamplerHandle;
    private int mVNoiseTextureID;*/
	...
	public void setSingleBitmapParams(int bProgram) {
        ...
        mBRandomCoord1Handle = GLES20.glGetUniformLocation(bProgram, "RandomCoord1");
        mBRandomCoord2Handle = GLES20.glGetUniformLocation(bProgram, "RandomCoord2");
        mBNoiseSamplerHandle = GLES20.glGetUniformLocation(bProgram, "NoiseSampler");*/		
	}
